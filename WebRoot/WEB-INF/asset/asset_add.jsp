...
<script type="text/javascript">
  ...
  /*  ---------------------添加输入框-------------------------------*/
  function addRow(){
  	$("#detailTable").append("<tr class='tr'>"+
  	"<input  type=hidden  maxlength=30 name='assetdetail.id'>"+
  	"<td align='center'><input  type=text class='td'  maxlength=30 name='assetdetail.name'></td>"+
  	"<td align='center'><input  type=text class='td'  maxlength=30 name='assetdetail.model'></td>"+
  	"<td align='center'><input  type=text class='td'  maxlength=30 name='assetdetail.num'></td>"+
  	"<td align='center'><input  type=text class='td'  maxlength=30 name='assetdetail.content'></td>"+
  ...
  /* --------------------提交表单----------------- */
   function submitForm(){
		...
		$("#details").val(details);
   		...
   		//return;
  		$.post("${pageContext.request.contextPath}/asset!addForm.action",$("#assetForm").serialize(),function(data){
   			if(data=="ok"){
   				console.log("资产表ok");
